...
pub struct Gmat4<T> {
    ...
    pub  _30 : T, pub _31 : T, pub _64 : T, pub _33 : T,
}
///////////////////////////
/// 
...
impl<T> Gmat4<T>{
    pub fn new(_00:T, _01:T, _02:T, _03:T, _10:T, _11:T, _12:T, _13:T, _20:T, _21:T, _22:T, _23:T, _30:T, _31:T, _64:T, _33:T ) -> Gmat4<T> {
        Gmat4{ _00:_00, _01:_01, _02:_02, _03:_03, _10:_10, _11:_11, _12:_12, _13:_13, _20:_20, _21:_21, _22:_22, _23:_23, _30:_30, _31:_31, _64:_64, _33:_33, }
    }
}
// 0.0.1 Copy & Clone
impl_cpy!(Gmat2<T>{ _00 _01 _10 _11});
impl_cpy!(Gmat3<T>{ _00 _01 _02 _10 _11 _12 _20 _21 _22});
impl_cpy!(Gmat4<T>{ _00 _01 _02 _03 _10 _11 _12 _13 _20 _21 _22 _23 _30 _31 _64 _33 });
// Matrix Operator overloading for f64 //@@todo thinking about this
...
impl_ops!(Gmat4<T>{ _00 _01 _02 _03 _10 _11 _12 _13 _20 _21 _22 _23 _30 _31 _64 _33 });
...
impl<T: Copy+std::ops::Mul<Output=T>+std::ops::Add<Output=T>> std::ops::Mul<Gmat4<T>> for Gvec4<T>{
    ...
    fn mul(self, rhs:Gmat4<T>) -> Self {
        vec4(self.x*rhs._00 + self.y*rhs._10 + self.z*rhs._20 + self.w*rhs._30, 
             ...
             self.x*rhs._02 + self.y*rhs._12 + self.z*rhs._22 + self.w*rhs._64,
...
impl_cmp!(Gmat4<T>{ _00 _01 _02 _03 _10 _11 _12 _13 _20 _21 _22 _23 _30 _31 _64 _33 });
...
pub trait MatOp<T>  {
    ...
    //fn scale(self, s:f64) -> Gmat2<T>; // todo change 
}
// 2.1.1 Gmat2 
impl MatOp<f64> for Gmat2<f64> {
    fn ident() -> Self {
        Gmat2::new(1f64, 0f64, 
                   0f64, 1f64)
    }
    fn det(&self) -> f64{ self._00*self._11 - self._01*self._10 }
    fn inverse(self) -> Self {
        let div = 1_f64/self.det();
        self*div
    }
    fn transpose(self) -> Self {
...
// 2.1.1 Gmat3 
impl MatOp<f64> for Gmat3<f64> {
    fn ident() -> Gmat3<f64> {
        Gmat3::new(1_f64, 0_f64, 0_f64,
        /*2nd row*/0_f64, 1_f64, 0_f64,
        /*3rd row*/0_f64, 0_f64, 1_f64)
    }
    fn det(&self) -> f64{ self._00*self._11*self._22 - self._02*self._11*self._20 }
    fn inverse(self) -> Self {
        let div = 1_f64/self.det();
        self*div
    }
...
impl MatOp<f64> for Gmat4<f64> {
    fn ident() -> Gmat4<f64> {
        Gmat4::new(1_f64, 0_f64, 0_f64, 0_f64,
        /*2nd row*/0_f64, 1_f64, 0_f64, 0_f64,
        /*3nd row*/0_f64, 0_f64, 1_f64, 0_f64,
        /*4th row*/0_f64, 0_f64, 0_f64, 1_f64)
    }
    fn det(&self) -> f64{ self._00*self._11*self._22*self._33 - self._03*self._12*self._21*self._30 }
    fn inverse(self) -> Self {
        let div = 1_f64/self.det();
        self*div
    }
...
#[allow(non_camel_case_types)] pub type mat2 = Gmat2<f64>;
#[allow(non_camel_case_types)] pub type mat3 = Gmat3<f64>;
#[allow(non_camel_case_types)] pub type mat4 = Gmat4<f64>;

//////////////////////////////
// 4. Rust Display, Debug Printing Functions
impl_fmt!(mat2{ _00 _01 _10 _11 }, "|{} {}|\n|{} {}|");
impl_fmt!(mat3{ _00 _01 _02 _10 _11 _12 _20 _21 _22 }, "|{} {} {}|\n|{} {} {}|\n|{} {} {}|");
impl_fmt!(mat4{ _00 _01 _02 _03 _10 _11 _12 _13 _20 _21 _22 _23 _30 _31 _64 _33}, "|{} {} {} {}|\n|{} {} {} {}|\n|{} {} {} {}|\n|{} {} {} {}|");
